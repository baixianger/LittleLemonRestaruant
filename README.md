...
## Getting Started
To run the app, you'll need to have *vscode*, *node.js*, *npm*, *expo cli* and *iso/android simulator* installed. Or you can use expo ![snack](https://snack.expo.dev) without any configurations on your local computer. 
